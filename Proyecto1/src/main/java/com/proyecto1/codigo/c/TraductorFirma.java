 ...
 *
 * <p>Produce el texto {@code "<tipoRetorno> <etiqueta>(<param1>, <param2>, ...)"},
 * SIN llave de apertura y SIN ";" final: el ensamblador del archivo completo
 * (fase posterior) decide si la línea va seguida de "{" (definición) o ";" (prototipo).
 *
 * <p><b>Sobre "this":</b> no hay caso especial. Para un método o constructor de Z,
 * {@link GeneradorC3D.Firma#parametros()} YA INCLUYE al receptor implícito como
 * su PRIMER elemento (así lo decidieron {@code Constructor.generarC3D} y
 ...
 * cualquier otro parámetro. No hay rama "si es el primero, entonces…".
 *
 ...
 * con compiladores antiguos). Por eso la lista vacía se emite como {@code "(void)"}.
 */
public final class TraductorFirma {

    private TraductorFirma() {}  // clase de utilidades, no instanciable

    /**
     * Devuelve la cabecera C de {@code firma}: tipoRetorno + etiqueta + parámetros.
     * Ejemplo: {@code "int Persona_getEdad(Persona* this)"}.
     *
     * <p>No incluye llave de apertura ni ";" final.
     */
     ...
     * querer armar la cabecera con otro formato (p. ej. con alineación en columnas,
     * o con la lista de parámetros indentada en varias líneas), y así no tiene que
