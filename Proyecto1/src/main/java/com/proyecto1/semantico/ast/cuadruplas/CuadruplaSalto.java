 ...
 * {@link #conEtiquetaDestino(String)} vive aquí y no en {@link Cuadrupla}: para
 * cualquier otra instrucción (un {@code print}, un {@code call}) "cambiarle el
 ...
 * {@link #conEtiquetaDestino(String)}.
 */
